...
import whisper  # Aggiungi questa libreria
...
def speech_to_text():
    ...
    try:
        ...
        model = whisper.load_model("base")  # Puoi usare "tiny", "small", ecc. per modelli più veloci

        # Legge il file audio
        print(f"Analisi del file audio: {file_path}")
